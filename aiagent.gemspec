...
Gem::Specification.new do |spec|
  ...
  spec.summary     = 'A Ruby SDK for interacting with AI Agents such as ChatGPT and Claude'
  spec.description = "Ruby SDK for interacting with LLM agents such as OpenAI's ChatGPT, Anthropic's Claude, and Ollama."
